...
//                                readfile(filepath + "\\" + filelist[i]);
	...
	public static void toZip(String srcDir, String outPathFile,boolean isDelSrcFile) throws Exception {
		...
		try {
			...
			System.out.printf("原文件:{}. 压缩到:{}完成. 是否删除原文件:{}. 耗时:{}ms. ",srcDir,outPathFile,isDelSrcFile,System.currentTimeMillis()-start);
		} catch (Exception e) {
...
//				File file = new File(outPath.substring(0, outPath.lastIndexOf('/')));
			...
			System.out.printf("文件:{}. 解压路径:{}. 解压完成. 耗时:{}ms. ",zipPath,descDir,System.currentTimeMillis()-start);
		}catch(Exception e){
			System.out.printf("文件:{}. 解压路径:{}. 解压异常:{}. 耗时:{}ms. ",zipPath,descDir,e,System.currentTimeMillis()-start);
	...
	public static void delDir(String dirPath) throws IOException {
		System.out.printf("删除文件开始:{}.",dirPath);
		long start = System.currentTimeMillis();
		try{
			...
			dirFile.delete();
			System.out.printf("删除文件:{}. 耗时:{}ms. ",dirPath,System.currentTimeMillis()-start);
		}catch(Exception e){
			System.out.printf("删除文件:{}. 异常:{}. 耗时:{}ms. ",dirPath,e,System.currentTimeMillis()-start);
